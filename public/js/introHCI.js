...
function addProjectCallback(result){
	// console.log(result);
	console.log("Returned project " + result.id);
	var $details = $('#project' + result.id + '.project .details');
...
function randomizeColors(e) {
	...
	$.get('/palette', randomizeColorCallback);
}

function randomizeColorCallback(result){
	console.log("Returned from palette route");
